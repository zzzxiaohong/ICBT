...
tl=zh
iter_num=1 # 1/2/3
trans_dir=$work_dir/output/checkpoints/ICBT/ICBT-conf/zh2en/iter$iter_num/$tdom/result
dout_data_dir=$work_dir/data/dout_data
datamono_dir=$work_dir/data/datamono/mono-zh
dest_dir=$work_dir/data/dataicbt/ICBT-conf/en2zh/iter$iter_num/$tdom
mkdir -p $dest_dir
