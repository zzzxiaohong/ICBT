...
tl=zh
iter_num=$2 # 1/2/3
trans_dir=$work_dir/output/checkpoints/ICBT/ICBT-dspec/zh2en/iter$iter_num/$tdom/result
dout_data_dir=$work_dir/data/dout_data
datamono_dir=$work_dir/data/datamono/mono-zh
dest_dir=$work_dir/data/dataicbt/ICBT-dspec/en2zh/iter$iter_num/$tdom
mkdir -p $dest_dir
