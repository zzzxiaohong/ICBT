...
# model_dir=$work_dir/output/checkpoints/ICBT/ICBT-dspec/en2zh/iter$((iter_num-1))/$tdom
# The path you need to import the model to continue training.
save_dir=$work_dir/output/checkpoints/ICBT/ICBT-dspec/en2zh/iter$iter_num/$tdom
data_dir=$work_dir/output/data-bin-join/ICBT/ICBT-dspec/en2zh/iter$iter_num/$tdom
