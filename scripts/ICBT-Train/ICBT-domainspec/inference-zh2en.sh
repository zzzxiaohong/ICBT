...
tl=en
iter_num=1 # 1/2/3
model_dir=$work_dir/output/checkpoints/ICBT/ICBT-dspec/zh2en/iter$iter_num/$tdom
data_dir=$work_dir/data/datatag/$dom/$dom-dspec
...
## 1 inference
cat $data_dir/train.bpe.tag.zh | nohup python $code_dir/interactive.py $dict_dir \
