...
model_dir=$work_dir/output/checkpoints/pre-train/$sl-$tl
 ...
 # or $work_dir/output/checkpoints/ICBT/ICBT-conf/en2zh/iter$iter_num/$tdom
...
## 1 inference
cat $data_dir/$tdom-train.bpe.mono.en.head | nohup python $code_dir/interactive.py $dict_dir \
