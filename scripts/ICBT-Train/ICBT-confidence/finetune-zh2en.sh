...
save_dir=$work_dir/output/checkpoints/ICBT/ICBT-conf/zh2en/iter$iter_num/$tdom
data_dir=$work_dir/output/data-bin-join/ICBT/ICBT-conf/zh2en/iter$iter_num/$tdom
