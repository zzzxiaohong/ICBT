...
bin_path=$work_dir/output/data-bin-join/ICBT/ICBT-dspec/zh2en/iter$iter_num/$tdom

mkdir -p $bin_path
data_path=$work_dir/data/dataicbt/ICBT-dspec/zh2en/iter$iter_num/$tdom-tag
